package com.mariaj.oestopmedishop.controllers;
...
public class AdminControllerTest {
	...
	public void testAddAdminUsers() {
		...
		adminObj.setPassword("Admin123");
		adminObj.setFirstName("Admin");
		adminObj.setLastName("Boss");
		...
		assertEquals("admin1@java.com", ((LinkedHashMap<String, String>) restResponse.getData()).get("email"));
	}
	...
	public void testAddAdminUsersExits() {
		...
		//create admin object
		Admin adminObj = new Admin();
		adminObj.setEmail("admin1@java.com");
		adminObj.setPassword("Admin123");
		adminObj.setFirstName("Admin");
		adminObj.setLastName("Boss");
		adminObj.setLoginType(2);
